...
import { Brain, Zap, Users, TrendingUp, LucideIcon } from "lucide-react";

const featureIcons: LucideIcon[] = [Brain, Zap, Users, TrendingUp];
          ...
          {["1", "2", "3", "4"].map((num, idx) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-foreground mb-2">
                {t(`features.features.${num}.title`)}
              </h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {t(`features.features.${num}.description`)}
              </p>
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
            ...
            <div className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors">
              ...
              <span className="font-medium">{t("channels.whatsapp")}</span>
            </div>
            ...
            <div className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors">
              ...
              <span className="font-medium">{t("channels.telegram")}</span>
            </div>
            ...
            <div className="flex items-center gap-2 text-muted-foreground">
              ...
              <span className="font-medium">{t("channels.moreComing")}</span>
            </div>
          </div>
        </motion.div>
      </div>
