...
export function formatUsagePeriod(
  ...
  try {
    ...
    console.error("Usage Period Format Error:", {
      error,
      periodStart,
      periodEnd,
    });
...
export function formatBillingInterval(
  ...
  try {
    ...
    console.error("Billing Interval Format Error:", {
      error,
      interval,
      intervalCount,
    });
 ...
 * @returns Formatted period string
 */
export function formatCurrentBillingPeriod(
  ...
  try {
    ...
    console.error("Current Billing Period Format Error:", {
      error,
      periodStart,
      periodEnd,
    });
