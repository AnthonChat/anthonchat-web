...
export type UserChannel = PublicDatabase["public"]["Tables"]["user_channels"]["Row"];
export type UserChannelInsert = PublicDatabase["public"]["Tables"]["user_channels"]["Insert"];
export type UserChannelUpdate = PublicDatabase["public"]["Tables"]["user_channels"]["Update"];
